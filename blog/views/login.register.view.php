    ...
    <div class="row">
        <div class="col-6">
            ...
            <form action="login_register.php" method="POST">
                ...
                <button type="submit" name="loginBtn" class="form-control btn btn-primary">Login</button>
            </form>
        ...
        <div class="col-6">
            ...
            <form action="login_register.php" method="POST">
                ...
                <button type="submit" name="registerBtn" class="form-control btn btn-warning">Register</button>
            </form>
